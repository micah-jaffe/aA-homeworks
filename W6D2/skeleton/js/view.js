...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $('li').on("click", event => alert($(event.currentTarget).attr("data-pos")));
};
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  $('.square').each((i, el) => $(el).css("background-color", _randomColorString()));
};
...
View.prototype.exercise7 = function(){
  ...
  //your code here!
  $('li').on("mouseenter", e => console.log($(e.currentTarget).css("background-color")));
};
